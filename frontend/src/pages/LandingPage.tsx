...
import { Upload, Search, Share2, Mic, ArrowRight, Copy, Download, Check, Menu, X } from 'lucide-react';
    ...
    <div ref={mainRef} className="relative">
      ...
      <nav className="nav-container fixed top-0 left-0 right-0 z-[100] px-[6vw] py-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link to="/signin" className="link-underline text-sm font-medium text-dark/80 hover:text-dark transition-colors">
            Sign in
          </Link>
          <Link to="/signin" className="btn-hover bg-lime text-dark font-semibold text-sm px-5 py-2.5 rounded-full inline-block">
            Start free
          </Link>
        </div>
        ...
        {/* Mobile hamburger */}
        <button
          className="md:hidden w-10 h-10 flex items-center justify-center rounded-xl hover:bg-dark/5 transition-colors"
      ...
      {/* Mobile menu */}
      <div
        className={`md:hidden mobile-menu-overlay ${mobileMenuOpen ? 'open' : ''}`}
        onClick={() => setMobileMenuOpen(false)}
      />
      <div className={`md:hidden mobile-menu ${mobileMenuOpen ? 'open' : ''}`}>
        <div className="flex items-center justify-between mb-6">
          <span className="font-heading font-bold text-lg text-dark">RhemaFlows</span>
          <button
            onClick={() => setMobileMenuOpen(false)}
            className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-dark/5 transition-colors"
            aria-label="Close menu"
          >
            <X className="w-5 h-5 text-dark" />
          </button>
        </div>
        <a href="#features" onClick={() => setMobileMenuOpen(false)} className="mobile-menu-link">Features</a>
        <a href="#how-it-works" onClick={() => setMobileMenuOpen(false)} className="mobile-menu-link">How it works</a>
        <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="mobile-menu-link">Pricing</a>
        <Link to="/signin" onClick={() => setMobileMenuOpen(false)} className="mobile-menu-link">Sign in</Link>
        <div className="mt-auto pt-4">
          <Link
            to="/signin"
            onClick={() => setMobileMenuOpen(false)}
            className="btn-hover bg-lime text-dark font-semibold text-sm px-6 py-3 rounded-full inline-flex items-center gap-2 w-full justify-center"
          >
      ...
      <section ref={heroRef} className="section-pinned bg-offwhite z-10">
        <div className="absolute inset-0 flex items-center justify-center md:absolute md:inset-0">
          <img 
            src="/hero_upload.jpg" 
        ...
        <p 
          ...
          style={{ left: '6vw', top: '36vh', width: '34vw', fontSize: 'clamp(14px, 1.1vw, 16px)' }}
        >
      ...
      <section ref={section2Ref} id="features" className="section-pinned bg-offwhite z-20">
        ...
        <h2 
          ...
          style={{ left: '6vw', bottom: '28vh', width: '46vw', fontSize: 'clamp(28px, 4.5vw, 58px)' }}
        >
      ...
      <section ref={section3Ref} id="how-it-works" className="section-pinned bg-offwhite z-30">
        ...
        <h2 
          ...
          style={{ left: '6vw', top: '14vh', width: '40vw', fontSize: 'clamp(28px, 4.5vw, 58px)' }}
        >
          HIGHLIGHT & EXTRACT
        </h2>
        ...
        <p 
          ...
          style={{ left: '6vw', top: '34vh', width: '34vw', fontSize: 'clamp(14px, 1.1vw, 16px)' }}
        >
      ...
      <section ref={section7Ref} id="pricing" className="relative bg-dark md:min-h-screen z-[70]">
        <div className="md:hidden px-[5vw] pb-10 pt-2">
          <img 
            src="/img_close.jpg" 
            alt="Get started" 
            className="s7-image w-full h-[28vh] object-cover opacity-80 rounded-2xl mt-[6vh]"
          />
          <h2 className="s7-headline font-heading font-black text-offwhite uppercase tracking-tight leading-[0.95] mt-[3vh]"
              style={{ fontSize: 'clamp(28px, 8vw, 40px)' }}>
            GET STARTED
          </h2>
          <p className="s7-body text-offwhite/70 font-medium leading-relaxed mt-[2vh] text-sm">
            Upload your first sermon. Extract your first quote. Share what matters.
          </p>
          <div className="s7-cta-group flex flex-wrap items-center gap-4 mt-[3vh]">
            <Link to="/signin" className="btn-hover bg-lime text-dark font-semibold px-8 py-3.5 rounded-full flex items-center gap-2">
              Start free <ArrowRight className="w-4 h-4" />
            </Link>
          ...
          <footer className="s7-footer mt-[6vh] pt-6 border-t border-offwhite/10">
        ...
        <div className="hidden md:block">
          ...
          <h2 
            ...
            style={{ left: '6vw', bottom: '32vh', width: '46vw', fontSize: 'clamp(28px, 4.5vw, 58px)' }}
          >
            GET STARTED
          </h2>
